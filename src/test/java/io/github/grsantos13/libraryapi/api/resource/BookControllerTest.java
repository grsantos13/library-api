package io.github.grsantos13.libraryapi.api.resource;

import io.github.grsantos13.libraryapi.api.dto.BookDTO;
...
import io.github.grsantos13.libraryapi.service.BookService;
...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception{
        ...
        Book savedBook = Book.builder()
                            .id(10L)
                            .author("Natália")
                            .title("As aventuras da família Santos")
                            .isbn("001")
                            .build();
    ...
    @Test
    @DisplayName("Lançar erro ao tentar cadastrar um livro com isbn já cadastrado.")
    ...
    public void updateBookTest() throws Exception{
        ...
        Book outdatedBook = Book.builder().id(1L).title("Título de Teste").author("Autor teste").isbn("001").build();
        ...
        BDDMockito.given( service.getById(id) )
                    .willReturn(Optional.of(outdatedBook));
        BDDMockito.given(service.update(outdatedBook))
